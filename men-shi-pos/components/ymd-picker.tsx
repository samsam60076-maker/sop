  ...
  return (
    <div className="flex flex-wrap items-center gap-1">
      <label className="flex items-center gap-1">
        ...
        <span className={cn(small ? "text-[11px]" : "text-sm", "text-muted-foreground")}>年</span>
      </label>
      <label className="flex items-center gap-1">
        <select
        ...
        <span className={cn(small ? "text-[11px]" : "text-sm", "text-muted-foreground")}>月</span>
      </label>
      <label className="flex items-center gap-1">
        <select
        ...
        <span className={cn(small ? "text-[11px]" : "text-sm", "text-muted-foreground")}>日</span>
      </label>
    </div>
  );
}
